...
@section('welcometeam')
	<section class="xs-banner-inner-section parallax-window" style="background-image:url('assets/images/backgrounds/team_bg.jpg')">
		...
		<div class="container">
			<div class="color-white xs-inner-banner-content">
				...
				<ul class="xs-breadcumb">
					<li class="badge badge-pill badge-primary"><a href="{{ URL::route('index') }}" class="color-white"> Inicio /</a> Equipo</li>
				</ul>
			</div>
		</div>
	</section>
