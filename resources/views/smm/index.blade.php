										...
										<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										  ...
										  <div class="carousel-inner">
											<div class="carousel-item active">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_1.jpg') }}" alt="First slide">
											  <div class="carousel-caption d-none d-md-block">
												<h5>El Sistema de Monitoreo Multiproposito es una iniciativa interinstitucional entre el CREDIA, Gobierno y la Union Europea</h5>
											  </div>
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_2.jpg') }}" alt="Second slide">
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_3.jpg') }}" alt="Third slide">
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_4.jpg') }}" alt="Third slide">
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_5.jpg') }}" alt="Third slide">
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_6.jpg') }}" alt="Third slide">
											  <div class="carousel-caption d-none d-md-block">
												<h5>Es un espacio de diálogo</h5>
											  </div>
											</div>
											<div class="carousel-item">
											  <img class="d-block w-100" src="{{ asset('img/smm-banner/img_7.jpg') }}" alt="Third slide">
											  <div class="carousel-caption d-none d-md-block">
												<h5>Para la toma de desiciones.</h5>
											  </div>
											</div>
										  </div>
