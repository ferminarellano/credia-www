...
Route::get('cendoc', 'FundacionController@cendoc')->name('cendoc');
...
Route::get('educacion-ambiental', 'FundacionController@educacion_ambiental')->name('edu_ambiental');
...
Route::get('observatorio', 'FundacionController@observatorio')->name('observatorio');
